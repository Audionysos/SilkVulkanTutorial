...
public unsafe class VKVertexIndexBuffer : VKComponent {
	...
	public Vertices verts = new() {
			...
			{(-0.5f, 0.5f, 0), ( 1.0f, 1.0f, 1.0f), (1, 1)},

			{(-0.5f, -0.5f, -.5f), (1.0f, 0.0f, 0.0f), (1, 0)},
			{(0.5f, -0.5f,  -.5f), (0.0f, 1.0f, 0.0f),  (0, 0)},
			{(0.5f, 0.5f,   -.5f), ( 0.0f, 0.0f, 1.0f),  (0, 1)},
			{(-0.5f, 0.5f,  -.5f), ( 1.0f, 1.0f, 1.0f), (1, 1)},
	};
